...
class PartsControllerTest < ActionController::TestCase
  ...
  test "should create part" do
    assert_difference('Part.count') do
      post :create, part: { description: @part.description, name: @part.name, number: @part.number, typ: @part.typ }
    end
  ...
  test "should update part" do
    patch :update, id: @part, part: { description: @part.description, name: @part.name, number: @part.number, typ: @part.typ }
    assert_redirected_to part_path(assigns(:part))
  end
